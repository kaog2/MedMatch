...
public static class DtoMapper
{
    ...
    public static ClinicDto ToClinicDto(Clinic clinic) => new(clinic.Id, clinic.Name, clinic.Type, clinic.Specialty, clinic.TreatmentsOffered, clinic.Address, clinic.City, clinic.Country, clinic.ContactInfo, clinic.IsVerified);
    public static void ApplyClinic(Clinic clinic, ClinicDto dto) { clinic.Name = dto.Name; clinic.Type = dto.Type; clinic.Specialty = dto.Specialty; clinic.TreatmentsOffered = dto.TreatmentsOffered ?? []; clinic.Address = dto.Address; clinic.City = dto.City; clinic.Country = dto.Country; clinic.ContactInfo = dto.ContactInfo; clinic.IsVerified = dto.IsVerified; }
